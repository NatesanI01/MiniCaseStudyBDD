...
public class ProductStorestepdef {
	...
	public void user_enters_login_credientials() {
		driver.findElement(By.xpath("//input[@id='loginusername']")).sendKeys("glass");
		driver.findElement(By.xpath("//input[@id='loginpassword']")).sendKeys("glass");
		driver.findElement(By.xpath("//button[contains(text(),'Log in')]")).click();
	}
	@Then("Should Display Home Page")
	public void should_display_home_page() {
		Assert.assertEquals(driver.findElement(By.xpath("//a[contains(text(),'Welcome glass')]")).getText(), "Welcome glass");
	}
	...
	public void place_order() {
		if(items.size()!=0) {
			...
			driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Glass");
			driver.findElement(By.xpath("//input[@id='country']")).sendKeys("India");
			driver.findElement(By.xpath("//input[@id='city']")).sendKeys("Tirunelveli");
			driver.findElement(By.xpath("//input[@id='card']")).sendKeys("6548 2136 98745");
			driver.findElement(By.xpath("//input[@id='month']")).sendKeys("06");
